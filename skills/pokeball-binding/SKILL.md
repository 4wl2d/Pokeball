...
description: "Implement or debug a Pokeball execution binding: single-writer acceptance, admission, dispatch, boundary adapters, scheduling, durable persistence and recovery. Use when those mechanisms change, rather than for a business-rule edit within an existing binding."
---
