...
Read only the matching table and source row, then the relevant §17 test section. Use the affected portion of [§18.1](../../spec/core/verification/18-checklist-and-antipatterns.md#181-core-ball-and-trigger-resolution) to check omissions; do not turn every checklist category into a finding or a mandatory artifact.
