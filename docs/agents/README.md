...
> **Status:** derived noncanonical package. It neither defines nor extends Pokeball Core. Before using it, pass the exact gate in [BASELINE.md](BASELINE.md). If package guidance conflicts with Core, Core prevails.
...
1. Verify [BASELINE.md](BASELINE.md).
...
3. an accepted exact project policy or deviation, only for choices Core leaves open;
